    ...
    <div class="container-fluid">
        ...
        foreach ($files as $k => $file) {
            ...
            elseif (is_dir($current_path . $rfm_subfolder . $subdir . $file)) {
                if ($subdir != '' || ($file == $config['ocms_SharedFolder'] || $file == $_SESSION['gs_admin_id'])) {
                                ...
                                <div class="box">
                                    <h4 class="<?php if ($ellipsis_title_after_first_row) {
                                        echo "ellipsis";
                                             ...
                                             href="dialog.php?<?php echo $get_params . rawurlencode($src) . "&" . uniqid() ?>"><?php echo empty($file_array['realname']) ? $file : $file_array['realname']; ?></a>
                                    </h4>
                                </div>
