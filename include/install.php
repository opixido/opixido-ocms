...
class genInstall {
	...
	public function checkConfig() {
		...
		$this->infoVersion('JPEG','Le support JPEG n\'est pas activ&eacute; cela emp&eacute;chera le redimensionnement automatique de ces images',
						function_exists('imagecreatefromjpeg'));	
						
		$this->infoVersion('PNG','Le support PNG n\'est pas activ&eacute; cela emp&eacute;chera le redimensionnement automatique de ces images',
						function_exists('imagecreatefrompng'));		

		$this->infoVersion('GIF','Le support GIF n\'est pas activ&eacute; cela emp&eacute;chera le redimensionnement automatique de ces images et la cr&eacute;ation automatique de textes en image',
						function_exists('imagecreatefromgif'));							
		
		$this->infoVersion('PS','Le support POSTSCRIPT n\'est pas activ&eacute; cela emp&eacute;chera la cr&eacute;ation automatique de textes en image',
						function_exists('imagepsloadfont'));	
