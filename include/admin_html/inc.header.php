...
<head>
    ...
    $js = array(
        ...
        'admin/plupload/js/plupload.full.min.js'
    );
        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container" style="width:auto!important">
                    <a class="brand"
                       style="padding-top:0;padding-bottom:5px;line-height:35px;color:white;position:relative;height:35px;"
                        ...
                        <div class="btn-toolbar pull-right">
                            ...
                            <div class="btn-group last">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <span class="badge"
                                              style="margin:10px;display: block"><?= ta('derniere_connexion') ?><br/><?= niceDateTime(($_SESSION['last_cx'])) ?></span>
                                    </li>
                                    <li class="divider"></li>
