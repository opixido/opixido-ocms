...
/**
 * Retourne le nom de la langue du champ pass� en parametre
 *
...
/**
 * Retourne la traduction d'un texte dans une langue donn�e
 *
 * @param unknown_type $table
 * @param unknown_type $id
 * @param unknown_type $champ
...
/**
 * Definit si le nom du champ pass� en paramètre est le champ de la langue par d�faut pour cette information
 *
 * @param string $champ
 * @return bool
 */
 ...
 * dans la table s_traduction pour un table et un champ donn�
 *
 * @param string $table
 * @param string $champ
 * @return array
...
/**
 * Retourne un tableau de toutes les langues disponibles pour le champ donn�
 *
 * @param str $champ
 * @param array $row
 * @param str $table
...
function getLgValue($k,$tab,$addspan='') {
	...
	if(defined('TRADLG') && TRADLG ) {
		...
		$found = false;
		/**
		 * On cherche � quelle table appartient ce champ
		 */
...
/**
 * V�rifie si le titre de cette rubrique est cens� etre dynamique
 *
 * @param unknown_type $res
 */
function getDynamicTitle($res) {

	if($res['rubrique_dyntitle']) {
...
/**
 * Verifie le champ en question est le champ dans la langue par d�faut
 *
