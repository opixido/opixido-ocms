...
$PHPTHUMB_CONFIG['cache_directory'] = dirname(__FILE__).'/../include/cache/';                            // set the cache directory relative to the phpThumb() installation
...
if (strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {
	...
	$PHPTHUMB_CONFIG['imagemagick_path'] = null;//'C:/ImageMagick/convert.exe';
} else {
